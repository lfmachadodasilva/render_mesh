...
EXTERN_C int WINAPI DIC_Close(int hic);
// Input:
...
EXTERN_C int WINAPI DIC_Create(char* filename, char* mfname, char* atr, WORD atrlen);
// Input:
...
EXTERN_C int WINAPI DIC_GetVersion(char* ver);
// Input:
...
EXTERN_C int WINAPI DIC_FindByMgrCode(void * pMgrCode);
// Input:
...
EXTERN_C int WINAPI DIC_Get(void* xdata, int p1, int p2, char* buffer);
...
EXTERN_C int WINAPI DIC_Set(void* xdata, int p1, int p2, int p3, char* buffer);
// Input:
