...
public:
  ...
  /**
   * Adds an interpolation point at position 'i', shifting all
   * following points up 1 position.
   */
  void AddPosition (int i, double x, double y, double z);
  ...
  /**
   * Removes the position at index 'i', shifting all
   * following positions down 1 position.
   */
  ...
  /**
   * Obtains the length, in world coordinates, between the points with
   * spline parameters t0 and t1.
   */
