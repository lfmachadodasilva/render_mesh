...
namespace sig {
	...
	public:
		virtual has_slots<mt_policy>* getdest() const = 0;
		virtual void send(arg1_type, arg2_type) = 0;
	...
	public:
		virtual has_slots<mt_policy>* getdest() const = 0;
		virtual void send(arg1_type, arg2_type, arg3_type) = 0;
	...
	public:
		virtual has_slots<mt_policy>* getdest() const = 0;
		virtual void send(arg1_type, arg2_type, arg3_type, arg4_type) = 0;
	...
	public:
		virtual has_slots<mt_policy>* getdest() const = 0;
		virtual void send(arg1_type, arg2_type, arg3_type, arg4_type, 
			arg5_type) = 0;
	...
	public:
		virtual has_slots<mt_policy>* getdest() const = 0;
		virtual void send(arg1_type, arg2_type, arg3_type, arg4_type, arg5_type,
			arg6_type) = 0;
	...
	public:
		...
		virtual void send(arg1_type a1)
		{
	...
	public:
		...
		virtual void send(arg1_type a1, arg2_type a2)
		{
	...
	public:
		...
		virtual void send(arg1_type a1, arg2_type a2, arg3_type a3)
		{
	...
	public:
		...
		virtual void send(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4,
			arg5_type a5)
		{
	...
	{
	  typedef _signal_base0<mt_policy> baseclass;
	public:
		signal0()
		{
			;
			...
			void connect(desttype* pclass, void (desttype::*pmemfun)())
		{
			...
			baseclass::m_connected_slots.push_back(conn);
		...
		{
			lock_block<mt_policy> lock(this);
			typename baseclass::connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
			typename baseclass::connections_list::const_iterator itEnd = baseclass::m_connected_slots.end();
		...
		// Removed for code clarity, use send() method instead
		//void operator()()
		//{
		//	lock_block<mt_policy> lock(this);
		//	typename connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
		//	typename connections_list::const_iterator itEnd = baseclass::m_connected_slots.end();
	...
	{
	  typedef _signal_base1<arg1_type, mt_policy> baseclass;
	public:
		signal1()
		{
			;
	...
	{
	  typedef _signal_base2<arg1_type, arg2_type, mt_policy> baseclass;
	public:
		signal2()
		{
			;
      ...
      baseclass::m_connected_slots.push_back(conn);
		...
		void send(arg1_type a1, arg2_type a2)
		{
			lock_block<mt_policy> lock(this);
			typename baseclass::connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
			typename baseclass::connections_list::const_iterator itEnd = baseclass::m_connected_slots.end();
	...
	{
	  typedef _signal_base3<arg1_type, arg2_type, arg3_type, mt_policy> baseclass;
	public:
		signal3()
		{
			;
      ...
      baseclass::m_connected_slots.push_back(conn);
		...
		void send(arg1_type a1, arg2_type a2, arg3_type a3)
		{
			lock_block<mt_policy> lock(this);
      typename baseclass::connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
			typename baseclass::connections_list::const_iterator itEnd = baseclass::m_connected_slots.end();
	...
	class signal4 : public _signal_base4<arg1_type, arg2_type, arg3_type,
		arg4_type, mt_policy>
	{
	  typedef _signal_base4<arg1_type, arg2_type, arg3_type, arg4_type, mt_policy> baseclass;
	public:
		signal4()
		{
			;
      ...
      baseclass::m_connected_slots.push_back(conn);
		...
		void send(arg1_type a1, arg2_type a2, arg3_type a3, arg4_type a4)
		{
			lock_block<mt_policy> lock(this);
			typename baseclass::connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
			typename baseclass::connections_list::const_iterator itEnd = baseclass::m_connected_slots.end();
	...
	{
	  typedef _signal_base5<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, mt_policy> baseclass;
	public:
		signal5()
		{
			;
	...
	{
	  typedef _signal_base6<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, mt_policy> baseclass;
	public:
		signal6()
		{
			;
	...
	{
	  typedef _signal_base7<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, arg7_type, mt_policy> baseclass;
	public:
		signal7()
		{
			;
	...
	class signal8 : public _signal_base8<arg1_type, arg2_type, arg3_type,
		arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, mt_policy>
	{
	  typedef _signal_base8<arg1_type, arg2_type, arg3_type, arg4_type, arg5_type, arg6_type, arg7_type, arg8_type, mt_policy> baseclass;
	public:
		signal8()
		{
			;
      ...
      typename baseclass::connections_list::const_iterator itNext, it = baseclass::m_connected_slots.begin();
			...
			while(it != itEnd)
			{
				...
				(*it)->send(a1, a2, a3, a4, a5, a6, a7, a8);
