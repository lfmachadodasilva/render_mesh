...
// Note: WaitCompletion() must be called on a started thread (possibly already
//       after termination) if the thread handle is to be freed.
// vbarata@tecgraf.puc-rio.br
// Jan 2010

#ifndef MTHREAD_THREAD_WINDOWS_H
#define MTHREAD_THREAD_WINDOWS_H
...
#endif // MTHREAD_THREAD_WINDOWS_H
