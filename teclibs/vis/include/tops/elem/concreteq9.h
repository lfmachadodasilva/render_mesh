...
#ifndef _TOP_CONCRETE_Q9_H
#define _TOP_CONCRETE_Q9_H
...
/**
  ...
  @endverbatim
*/
class TOPS_API TopConcreteQ9 : public TopConcreteElement
{
private:
...
public:
  ...
  virtual bool Serialize(IOStream* io)
  {
    return TopConcreteElement::Serialize(io)      &&
           io->WriteUInts(9, (unsigned*) m_nodes) &&
  ...
  virtual bool Deserialize(IOStream* io)
  {
    return TopConcreteElement::Deserialize(io)   &&
           io->ReadUInts(9, (unsigned*) m_nodes) &&
