...
#ifndef _TOP_CONCRETE_Q4_H
#define _TOP_CONCRETE_Q4_H

#include "../defines.h"

/**
    Linear 2D quadrangular element.
  ...
  @endverbatim
*/
class TOPS_API TopConcreteQ4 : public TopConcreteElement
{
private:
