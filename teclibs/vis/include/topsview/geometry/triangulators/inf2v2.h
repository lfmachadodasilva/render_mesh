...
// May 2008
#ifndef TPV_ELEM_INF2V2_TRIANGULATOR_H
#define TPV_ELEM_INF2V2_TRIANGULATOR_H

#include "../triangulator.h"

class TPV_API TpvElemInf2V2Triangulator : public TpvTriangulator
{
public:
  /**
   * Constructor
   */
  TpvElemInf2V2Triangulator ();
  
  /**
   * Destructor
   */
  virtual ~TpvElemInf2V2Triangulator ();
