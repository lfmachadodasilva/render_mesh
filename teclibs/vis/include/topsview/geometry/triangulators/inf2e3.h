...
// May 2008
#ifndef TPV_ELEM_INF2E3_TRIANGULATOR_H
#define TPV_ELEM_INF2E3_TRIANGULATOR_H

#include "../triangulator.h"

class TPV_API TpvElemInf2E3Triangulator : public TpvTriangulator
{
public:
  /**
   * Constructor
   */
  TpvElemInf2E3Triangulator ();
  
  /**
   * Destructor
   */
  virtual ~TpvElemInf2E3Triangulator ();
