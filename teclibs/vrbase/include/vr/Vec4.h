...
/*!
	...
	You should use the classes vr::Vec4f or vr::Vec4d instead.
 */
...
public:
	...
	inline Vec4( const Vec3<real>& vec, real scalar4 );
	...
	inline bool operator==( const Vec4<real>& other ) const;
...
template<typename real>
inline std::ostream& operator<<( std::ostream& stream, const vr::Vec4<real>& vec )
{
...
template<typename real>
Vec4<real>::Vec4( const Vec3<real>& vec, real scalar4 )
	: x( vec.x ), y( vec.y ), z( vec.z ), w( scalar4 )
{
}
...
template<typename real>
bool Vec4<real>::operator==( const Vec4<real>& other ) const
{
...
/************************************************************************/
/* Vec4<real> Instantiations                                            */
/************************************************************************/

//! 4D vector using float precision.
typedef Vec4<float>  Vec4f;

//! 4D vector using double precision.
